...
<template>
  <svg width="1em" height="1em" viewBox="0 0 512 512">
    <rect width="64" height="368" x="32" y="96" fill="none" stroke="currentColor" strokeLinejoin="round" rx="16"
      ry="16"></rect>
    <path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="32"
      d="M112 224h128M112 400h128"></path>
    <rect width="128" height="304" x="112" y="160" fill="none" stroke="currentColor" strokeLinejoin="round" rx="16"
      ry="16"></rect>
    <rect width="96" height="416" x="256" y="48" fill="none" stroke="currentColor" strokeLinejoin="round" rx="16"
      ry="16"></rect>
